...
import com.example.spoteam_android.presentation.interestarea.GetHostInterface
...
class MandateStudyOwnerReasonFragment(
    ...
    private fun showMemberLeaveSuccessDialog() {
        val successDialog =
            com.example.spoteam_android.presentation.mypage.HostLeaveStudySuccessDialog(
                context,
                onComplete
            )
        successDialog.start()
